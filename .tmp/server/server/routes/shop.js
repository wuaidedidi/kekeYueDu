...
// 获取用户余额
router.get('/shop/balance', authenticateToken, async (req, res) => {
    try {
...
// 兑换商品
router.post('/shop/redeem', authenticateToken, async (req, res) => {
    try {
        const userId = req.user.id || req.user.userId;
...
// 获取用户权益
router.get('/shop/user-rights', authenticateToken, async (req, res) => {
    try {
        const userId = req.user.id || req.user.userId;
...
// 充值墨水（管理员功能或测试用）
router.post('/shop/recharge', authenticateToken, async (req, res) => {
    try {
        const userId = req.user.id || req.user.userId;
