...
// 创建章节版本
router.post('/chapters/:chapterId/versions', async (req: Request, res: Response) => {
  try {
...
// 获取章节版本列表
router.get('/chapters/:chapterId/versions', async (req: Request, res: Response) => {
  try {
    const chapterId = parseInt(req.params.chapterId)
...
// 置顶/取消置顶版本
router.post('/chapters/:chapterId/versions/:versionId/pin', async (req: Request, res: Response) => {
  try {
    const chapterId = parseInt(req.params.chapterId)
...
// 删除版本
router.delete('/chapters/:chapterId/versions/:versionId', async (req: Request, res: Response) => {
  try {
    const chapterId = parseInt(req.params.chapterId)
    const versionId = parseInt(req.params.versionId)
...
// 回退到指定版本
router.post('/chapters/:chapterId/revert', async (req: Request, res: Response) => {
  try {
    const chapterId = parseInt(req.params.chapterId)
    ...
    const { newVersion, revertedVersion } = await revertToVersion(
      chapterId,
      toVersionId,
      author_id || 1
    )
